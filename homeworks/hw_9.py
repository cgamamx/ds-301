...
test_result = hypothesis.single_mean_test(salary_data['Age'], mu_0=50, tail='left-tail')
...
p_relapse_with_placebo = (cocaine_data.where(cocaine_data['Drug'] == 'Placebo')
                                      ...
                                      .squeeze())
test_result = hypothesis.single_proportion_test(p_relapse_with_placebo, category='no', p_0=0.30, tail='left-tail')
...
p_non_relapse = (cocaine_data.where(cocaine_data['Relapse'] == 'no')
                             ...
                             .squeeze())
test_result = hypothesis.two_proportions_test(p_non_relapse, categories=('Lithium', 'Placebo'), tail='right-tail')
